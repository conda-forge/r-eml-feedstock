About r-eml-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-eml-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1105&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-eml-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-eml` can be installed with `conda`:
...
It is possible to list all of the versions of `r-eml` available on your platform with `conda`:
...
```
mamba search r-eml --channel conda-forge
```
...
mamba repoquery search r-eml --channel conda-forge

# List packages depending on `r-eml`:
mamba repoquery whoneeds r-eml --channel conda-forge

# List dependencies of `r-eml`:
mamba repoquery depends r-eml --channel conda-forge
```
